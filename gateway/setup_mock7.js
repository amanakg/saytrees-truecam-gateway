...
// 3. Create exactly 7 mock cameras for an 8-way split screen (1 Real + 7 Mocks)
for (let i = 1; i <= 7; i++) {
  insertStmt.run(
    `MOCK_CAM_${i}`, 
    '08ce8ae8a9e468d2313c03c9e058a3c2', 
...
console.log("Database wiped clean and reset: EXACTLY 1 Real Camera + 7 Mock Cameras.");
