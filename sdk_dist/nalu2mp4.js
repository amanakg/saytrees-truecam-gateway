...
Module["locateFile"] = function(url){
    if(url == "decoder-pro.wasm" && typeof JESSIBUCA_PRO_WASM_URL != "undefined" && JESSIBUCA_PRO_WASM_URL != "")
        return JESSIBUCA_PRO_WASM_URL;
    else
        return url;
}
...
var ASM_CONSTS = {
  ...
  function craftEmvalAllocator(argCount) {
      ...
      /*jshint evil:true*/
      return (new Function("requireRegisteredType", "Module", "valueToHandle", "HEAPU32" , functionBody))(
          requireRegisteredType, Module, Emval.toHandle, HEAPU32);
    }
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 142348;
